...
API_ID = int(os.environ.get("API_ID", 8892215))
API_HASH = os.environ.get("API_HASH", "2e75ee01a9a8e2e5ee63b2705b650e03")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8004242153:AAHKVgLeSbOWT1xh4fnVlGTGBe2dWAOzNR0")
